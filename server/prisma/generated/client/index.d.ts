...
export namespace Prisma {
  ...
  */
  ...
  export type SubscriberMinAggregateOutputType = {
    id: bigint | null
    email: string | null
    sentFreq: string | null
    isUnsub: boolean | null
  ...
  export type SubscriberOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "email" | "topics" | "sentFreq" | "isUnsub" | "lastSentAt" | "createdAt", ExtArgs["result"]["subscriber"]>
  ...
  interface SubscriberFieldRefs {
    readonly id: FieldRef<"Subscriber", 'BigInt'>
    readonly email: FieldRef<"Subscriber", 'String'>
    readonly topics: FieldRef<"Subscriber", 'String[]'>
    readonly sentFreq: FieldRef<"Subscriber", 'String'>
    readonly isUnsub: FieldRef<"Subscriber", 'Boolean'>
    readonly lastSentAt: FieldRef<"Subscriber", 'DateTime'>
  ...
  export type SubscriberWhereInput = {
    ...
    id?: BigIntFilter<"Subscriber"> | bigint | number
    email?: StringFilter<"Subscriber"> | string
    topics?: StringNullableListFilter<"Subscriber">
    sentFreq?: StringFilter<"Subscriber"> | string
    isUnsub?: BoolFilter<"Subscriber"> | boolean
    lastSentAt?: DateTimeNullableFilter<"Subscriber"> | Date | string | null
  ...
  export type SubscriberScalarWhereWithAggregatesInput = {
    ...
    id?: BigIntWithAggregatesFilter<"Subscriber"> | bigint | number
    email?: StringWithAggregatesFilter<"Subscriber"> | string
    topics?: StringNullableListFilter<"Subscriber">
    sentFreq?: StringWithAggregatesFilter<"Subscriber"> | string
    isUnsub?: BoolWithAggregatesFilter<"Subscriber"> | boolean
    lastSentAt?: DateTimeNullableWithAggregatesFilter<"Subscriber"> | Date | string | null
  ...
  export type SubscriberCreateInput = {
    id?: bigint | number
    email: string
    topics?: SubscriberCreatetopicsInput | string[]
    sentFreq?: string
    isUnsub?: boolean
  ...
  export type SubscriberUpdateInput = {
    ...
    topics?: SubscriberUpdatetopicsInput | string[]
    sentFreq?: StringFieldUpdateOperationsInput | string
    isUnsub?: BoolFieldUpdateOperationsInput | boolean
  ...
  export type SubscriberCreatetopicsInput = {
    set: string[]
  }

  export type SubscriberUpdatetopicsInput = {
    set?: string[]
    push?: string | string[]
  }
